...
namespace Fricks.Repository.Repositories
{
    public class VoucherRepository : GenericRepository<Voucher>, IVoucherRepository
    {
        ...
        {
            var result = await _context.Vouchers.FirstOrDefaultAsync(x => x.Code == code && x.StoreId == storeId);
            return result;
        }
        ...
        public async Task<Pagination<Voucher>> GetVoucherByStore(int storeId, PaginationParameter paginationParameter)
        {
            ...
            var items = await _context.Vouchers.Skip((paginationParameter.PageIndex - 1) * paginationParameter.PageSize)
